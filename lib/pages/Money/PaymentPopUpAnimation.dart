...
import 'package:yibe_final_ui/model/money.dart';
                          ...
                          child: _isConfirmed
                              ...
                              : Column(children: [
                                  ListTile(
                                    ...
                                    leading: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                            image: AssetImage(
                                                'assets/images/vaibhavi_square.png'), //TODO: Replace with actual profile url of borrower
                                            fit: BoxFit.cover),
                                      ),
                                    ),
                                    title:
                                        widget.borrowerData['username'] == null
                                            ? Text("Null")
                                            : Text(
                                    ...
                                    subtitle:
                                        widget.borrowerData['email'] == null
                                            ? Text("Null")
                                            : Text(
                                      ...
                                      onTap: () {
                                        if (_amount.text != '' &&
                                          ...
                                          TransactionDetails b =
                                              TransactionDetails(
                                                  id: docId,
                                                  name: widget.borrowerData[
                                                      'username'],
                                                  email: widget.borrowerData[
                                                      'email'],
                                                  amount:
                                                      int
                                                          .parse(
