...
class MoneyDatabaseService {
  ...
  Future addTransactionDetails(Map borrowerDetails, Map lenderDetails,
      String borrowerId, String transactionId) async {
  ...
  Future settleALentTransaction(
      String transactionId, String settledDate) async {
    ...
    await usersCollection
        ...
        .collection('Lent')
        .doc(transactionId)
        .update({'isActive': false, 'settledOn': settledDate});
  }

  Future settleABorrowedTransaction(
      String transactionId, String settledDate) async {
